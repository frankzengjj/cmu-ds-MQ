...
public final class CounterServer implements Closeable {
  ...
  public static void main(String[] args) {
    try {
      ...
      if (peerIndex < 0 || peerIndex > 3) {
        throw new IllegalArgumentException("The server index must be 0, 1 or 2,3: peerIndex=" + peerIndex);
      }
      ...
      System.err.println();
      System.err.println("       peer_index must be 0, 1 or 2, 3");
      System.exit(1);
    }
  }
